...
credentials = ServiceAccountCredentials.from_json_keyfile_name('python-rpg20230630-cb65905c081e.json', scope)

#OAuth2の資格情報を使用してGoogle APIにログインします。
gc = gspread.authorize(credentials)

#共有設定したスプレッドシートキーを変数[SPREADSHEET_KEY]に格納する。
SPREADSHEET_KEY = '1vGnC8cdXODRiIcoPKS4zD-YLDXV6rSHuePtLdMGddeM'
